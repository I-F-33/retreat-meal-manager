package com.cpsc464.retreat_meal_manager.application.purchaselist;
...
import com.cpsc464.retreat_meal_manager.domain.purchaselist.PurchaseListStatus;
import com.cpsc464.retreat_meal_manager.domain.services.IngredientAggregationService;
import com.cpsc464.retreat_meal_manager.domain.session.Session;
import com.cpsc464.retreat_meal_manager.infrastructure.persistence.purchaselist.PurchaseListRepository;
...
public class PurchaseListService {
    ...
    public PurchaseList getPurchaseListBySession(Long sessionId) {
        return purchaseListRepository.findBySessionSessionId(sessionId)
