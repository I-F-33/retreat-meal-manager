package com.cpsc464.retreat_meal_manager.application.mealperiod;
...
import com.cpsc464.retreat_meal_manager.infrastructure.persistence.mealperiod.MealPeriodRepository;
import com.cpsc464.retreat_meal_manager.infrastructure.persistence.menu.MenuRepository;
...
public class MealPeriodService {
    ...
    public List<MealPeriod> getMealPeriodsByDay(Long dayId) {
        return mealPeriodRepository.findByDayDayId(dayId);
    }
    ...
    public MealPeriod getMealPeriodByDayAndType(Long dayId, MealPeriodType type) {
        return mealPeriodRepository.findByDayDayIdAndMealPeriodType(dayId, type)
